...
<%@ Register Assembly="SitecoreStuff.Foundation.HyperlinkManagerExtender" Namespace="SitecoreStuff.Foundation.HyperlinkManagerExtender.Controls" TagPrefix="alpha" %>
<script type="text/javascript">
	...
	Telerik.Web.UI.Widgets.LinkManager.prototype = {
		...
		_loadLinkProperties: function () {
			...
			this._hyperlinkManagerExtenderLoadLinkProperties(currentLink);
		...
		setupChildren: function () {
			...
			this._hyperlinkManagerExtenderSetupChildren();
		...
		_hyperlinkManagerExtenderSetupChildren: function() { },
		_hyperlinkManagerExtenderLoadLinkProperties: function(currentLink) { },
		_hyperlinkManagerExtenderGetModifiedLink: function(resultLink) { }
	}
	...
	<div class="redSection redSectionTop">
				...
				<telerik:RadMultiPage ID="dialogMultiPage" runat="server" SelectedIndex="0">
					<telerik:RadPageView ID="hyperlinkFieldset" runat="server">
                            ...
                            <alpha:HyperlinkManagerExtender runat="server" />
